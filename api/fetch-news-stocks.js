...
/**
 * Handles fetching either general stock news or news about a specific ticker serverlessly.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const ticker = req.query.ticker || ""; //If there's a ticker, include its value, else make blank
    const limit = req.query.limit || "10"; //If there's a specified news amount, use that value, else 10

    //Decode ticker string to use characters
